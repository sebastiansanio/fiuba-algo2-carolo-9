...
/*PRE: listaDEC creada */
/*POST: Si la lista est� vac�a devuelve LISTA_VACIA, sino elimina el actual elemento corriente y el corriente pasa a ser el siguiente */
...
/*PRE: listaDEC creada */
/*POST: Si la lista est� vac�a devuelve LISTA_VACIA. Si posicion es 0 el corriente pasa al primero, sino el corriente se mueve la cantidad
en posicion (hacia izquierda o derecha seg�n el signo)  */
...
/*PRE: listaDEC creada */
/*POST: Si la lista est� vac�a devuelve LISTA_VACIA, sino guarda en corriente elemento */
...
/*PRE: listaDEC creada */
/*POST: Si la lista est� vac�a devuelve 1, sino devuelve 0 */
...
/*PRE: listaDEC creada y no vac�a */
...
/*PRE: ldec creada, elemento y posici�n validos*/
/*POST: Inserta seg�n posici�n el elemento en la lista, devuelve FALTA_MEMORIA si no pudo insertar, y ELEMENTO_INSERTADO si pudo*/
